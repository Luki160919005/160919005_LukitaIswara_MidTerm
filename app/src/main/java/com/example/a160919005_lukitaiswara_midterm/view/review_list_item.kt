 ...
 * Use the [review_list_item.newInstance] factory method to
 * create an instance of this fragment.
 */
class review_list_item : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment review_list_item.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            review_list_item().apply {
